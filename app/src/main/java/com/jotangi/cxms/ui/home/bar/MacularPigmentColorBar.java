...
public class MacularPigmentColorBar extends View {

    private int[] barColor = {
            Color.rgb(236, 103, 97),
            Color.rgb(250, 156, 85),
    ...
    private int[] levelValues = {0, 26, 50, 75, 100};
    ...
    public MacularPigmentColorBar(Context context) {
        super(context);
        init();
    }

    public MacularPigmentColorBar(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public MacularPigmentColorBar(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();
    }

    public MacularPigmentColorBar(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        String[] sList = {"0", "0.26", "0.5", "0.75", "1"};
    ...
    public void initLegend() {
        barLabel = new String[]{"不足", "中度流失", "輕度流失", "正常"};
    }
